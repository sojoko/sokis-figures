    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg z-10 max-w-md w-full">
        ...
        <ol className="list-decimal pl-5 space-y-2">
          ...
          <li className=''> <span className='text-cyan-600 font-bold'>Calcula una figura irregular</span>
            <ul className="list-disc pl-5">
        ...
        <button
          className="mt-6 bg-pink-500 hover:bg-pink-400 text-white px-4 py-2 rounded"
          onClick={onClose}
        >
          Aceptar
        </button>
